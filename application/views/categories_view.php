...
<body>
  ...
  <div class="col-md-2">
    ...
    <hr>
    <ul class="nav nav-pills nav-stacked">
      <li class="active"><a href="<?=base_url()?>index.php/admin/categories">Категории</a></li>
        ...
        <div class="thumbnail">
          <div class="caption">
            ...
            <table>
              ...
              <td>
                  <form method="POST" action="<?=base_url()?>index.php/admin/delCat">
                    <input type="text" name="catID" hidden value=<?=$cat['catID'] ?>>
