...
<body>
  ...
  <div class="col-md-2">
    ...
    <ul class="nav nav-pills nav-stacked">
      ...
      <li class="active"><a href="<?=base_url()?>index.php/admin/add_categories">Добавить</a></li>
    </ul>
    <hr>
    <ul class="nav nav-pills nav-stacked">
  ...
  <div class="container-fluid">
    <h3>Добавление категории в список:</h3>
    <form method="POST" action="<?=base_url()?>index.php/admin/add_categories">
      <div class="col-md-3" style="position: absolute; left: 20%">
        <p><input type="text" placeholder="Категория" name="name"?></p>
        <button class="btn btn-lg btn-success btn-block"name='enter' type="submit">Добавить</button>
<?php
        if(isset($error)){ 
         if($error =='Категория успешно добавлена!') {
?>        
