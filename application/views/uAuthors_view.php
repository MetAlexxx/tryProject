...
<body>
  ...
  <div class="col-md-2">
    ...
    <hr>
    <ul class="nav nav-pills nav-stacked">
      <li class="active"><a href="<?=base_url()?>index.php/user/authors">Авторы</a></li>       
    </ul>
    <hr>
    <ul class="nav nav-pills nav-stacked">
        ...
        <div class="thumbnail">
          <div class="caption">
            ...
            <table>
              ...
              <td>
                <form method="POST" action="<?=base_url()?>index.php/user/SearchBooksA">
                  <input type="text" name="aID" hidden value=<?=$author['aID'] ?>>
                  <button class="btn btn-sm btn-info btn-block" name="authorS" type="submit">
