...
<body>
  ...
  <div class="col-md-2">
    ...
    <hr>
    <ul class="nav nav-pills nav-stacked">
      <li class="active"><a href="<?=base_url()?>index.php/admin/authors">Авторы</a></li>
        ...
        <div class="thumbnail">
          <div class="caption">
            ...
            <table>
              ...
              <td>
                  <form method="POST" action="<?=base_url()?>index.php/admin/delA">
                    <input type="text" name="aID" hidden value=<?=$author['aID'] ?>>
