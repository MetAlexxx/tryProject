...
<body>
  			...
  			<div class="row">
	   			<div class="navbar-header col-md-4">
	     			<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
	      			...
	      			<a class="navbar-brand" href="<?=base_url()?>index.php/admin">Библиотека</a>
	    		</div>
	    		<div class="col-md-5">
		    		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      			<form class="navbar-form navbar-left" method="POST" action="<?=base_url()?>index.php/admin/SearchBooks">
	...
	<div class="col-md-2">
	    ...
	    <hr>
	    <ul class="nav nav-pills nav-stacked">
	      <li class="active"><a href="<?=base_url()?>index.php/admin/books">Книги</a></li>
...
?>				</p>
                ...
                <form class="col-md-6" method="POST" action="<?=base_url()?>index.php/admin/editBooks">
			        <input type="text" name="bID" hidden value=<?= $book['bID'] ?>>
			        <button class="btn btn-sm btn-warning btn-block" name='edit' type="submit">Изменить </button>
			    </form>
		        <form class="col-md-6" method="POST" action="<?=base_url()?>index.php/admin/delBooks">
		        	<input type="text" name="bID" hidden value=<?= $book['bID'] ?>>
